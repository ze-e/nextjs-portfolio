...
export default function TwoColumn({column1, column2, column_1_flex, column_2_flex, column_1_maxW, column_2_maxW, lockH, ...props}) {
  return (
    <div className={`${styles.twoColumn} ${lockH && styles.lockH} ${props.className}`} >
